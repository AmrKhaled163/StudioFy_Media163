...
const App: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen font-cairo transition-colors duration-300 ${
    ...
    >
      ...
      <main>
        ...
        <section
          id="services"
          className="py-24 bg-white dark:bg-black relative overflow-hidden transition-colors duration-300"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <span className="gold-text font-bold text-sm tracking-widest uppercase mb-4 block">
                حلولنا التسويقية
              </span>
              <h2 className="text-4xl md:text-5xl font-black text-black dark:text-white">
                باقات تناسب نمو مشروعك
              </h2>
